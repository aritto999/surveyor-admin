<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="?pages=buat_project" class="menu-link">
                        <div data-i18n="Without menu">Buat Project</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="?pages=prject_list" class="menu-link">
                        <div data-i18n="Without navbar">Daftar Project</div>
                    </a>
                </li>
            </ul>
        </li>
